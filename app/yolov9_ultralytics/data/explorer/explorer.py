...
from app.yolov9_ultralytics.data.augment import Format
from app.yolov9_ultralytics.data.dataset import YOLODataset
from app.yolov9_ultralytics.data.utils import check_det_dataset
from app.yolov9_ultralytics.models.yolo.model import YOLOv9
from app.yolov9_ultralytics.utils import LOGGER, USER_CONFIG_DIR, IterableSimpleNamespace, checks
...
class Explorer:
    ...
    def _yield_batches(self, dataset: ExplorerDataset, data_info: dict, model: YOLOv9, exclude_keys: List[str]):
