...
from app.yolov9_ultralytics import YOLOv9, YOLOWorld
from app.yolov9_ultralytics.cfg import TASK2DATA, TASK2METRIC
from app.yolov9_ultralytics.engine.exporter import export_formats
from app.yolov9_ultralytics.utils import ARM64, ASSETS, IS_JETSON, IS_RASPBERRYPI, LINUX, LOGGER, MACOS, TQDM, WEIGHTS_DIR
from app.yolov9_ultralytics.utils.checks import IS_PYTHON_3_12, check_requirements, check_yolo
from app.yolov9_ultralytics.utils.downloads import safe_download
from app.yolov9_ultralytics.utils.files import file_size
from app.yolov9_ultralytics.utils.torch_utils import select_device
    ...
    for i, (name, format, suffix, cpu, gpu) in export_formats().iterrows():  # index, (name, format, suffix, CPU, GPU)
        ...
        try:
            ...
            if format == "-":
                ...
                exported_model = YOLOv9(filename, task=model.task)
