...
def collect_system_info():
    ...
    from app.yolov9_ultralytics.utils import ENVIRONMENT, IS_GIT_DIR
    from app.yolov9_ultralytics.utils.torch_utils import get_cpu_info
...
def check_amp(model):
    ...
    try:
        from app.yolov9_ultralytics import YOLOv9

        assert amp_allclose(YOLOv9("yolov8n.pt"), im)
