...
from app.yolov9_ultralytics.utils.checks import check_imshow, check_requirements
from app.yolov9_ultralytics.utils.plotting import Annotator
...
class ParkingManagement:
    ...
    def load_model(self):
        ...
        self.model = YOLOv9(self.model_path)
        return self.model
